...
export const strings = {
  voice: {
    ...
    insert: (label: string): string => `Inserir em ${label}`, chooseTarget: "Selecione um composer para inserir",
    cancelling: "Cancelando… aguarde para gravar novamente.",
    phase: { idle: "", requesting_permission: "Aguardando permissão do microfone", recording: "Gravando", transcribing: "Transcrevendo localmente…", ready: "Transcrição pronta", cancelled: "Gravação cancelada", error: "Não foi possível transcrever" },
    error: (reason: string): string => ({
      model_unavailable: "Selecione um modelo local disponível.", invalid_model: "O arquivo não é um modelo GGML compatível.",
      model_language_unsupported: "Escolha um modelo multilíngue, com suporte a português.",
      ...
      audio_format_unsupported: "O formato do microfone não é compatível.", audio_overrun: "A captura não acompanhou o áudio. Tente novamente.",
      no_speech: "Nenhuma fala foi reconhecida.", voice_busy: "Já existe um trabalho de voz em andamento.",
      voice_model_busy: "Conclua a seleção do modelo antes de gravar.", voice_results_full: "Feche um cartão de transcrição para gravar mais. Copie o texto antes, se precisar.",
      voice_target_stale: "A sessão mudou. Selecione o destino novamente.", daemon_unavailable: "Aguarde a conexão com o daemon para gravar.",
      daemon_incompatible: "Atualize o daemon para usar a voz nesta versão.",
    }[reason] ?? "Não foi possível concluir a operação de voz. Seu rascunho foi preservado."),
  },
  recovery: {
    title: "Textos recuperáveis",
    text: "Texto da mensagem preservada",
    memory: "Os textos ficam neste aplicativo até você descartá-los ou fechar o app. Copiar não reenvia nem interrompe o agente.",
    ...
    discardFailed: "Não foi possível descartar o texto. Tente novamente.",
    loadFailed: "Não foi possível consultar os textos recuperáveis.",
  },
  connection: {
    discovering: "Identificando as sessões locais…",
    connecting: "Conectando ao Open Island…",
    reconnecting: "Reconectando… Os dados exibidos podem estar desatualizados.",
  ...
  island: {
    ...
    emptyHint: "Abra uma sessão com + ou inicie um agente no terminal. Ela aparece aqui sozinha.",
  },
  usage: {
  ...
  session: {
    ...
    deliveryState: { queued: "Enfileirada", sending: "Enviando", delivered: "Entregue ao canal", failed: "Falha na entrega", unconfirmed: "Entrega não confirmada" },
    deliveryConfirmed: "O canal recebeu a mensagem. Isso não confirma a execução da tarefa.",
    deliverySending: "A entrega está em andamento. Não é possível desfazer bytes já enviados.",
    deliveryDiscard: "Descartar registro",
    deliveryDetached: "Mensagens de outras sessões",
    deliveryDiscardFailed: "Não foi possível descartar a mensagem. O texto foi preservado.",
    deliveryFailed: "A mensagem não foi entregue. Copie o texto para revisar antes de enviar novamente.",
  ...
  settings: {
    ...
    about: {
      ...
      diagnosticHint: "Consulta local, sem iniciar ou reiniciar serviços. O relatório não contém sessões, mensagens ou caminhos pessoais.",
      ...
      diagnosticUnchecked: "Não foi possível verificar",
      diagnosticAudioLabel: "Entrada de áudio",
      diagnosticAudioDetected: "Entrada ALSA detectada; captura não testada",
      diagnosticAudioNotDetected: "Nenhuma entrada ALSA detectada; fontes virtuais não verificadas",
      diagnosticAudioUnchecked: "Entrada e captura ainda não verificadas",
      diagnosticHooksLabel: "Hooks dos agentes",
      diagnosticHooksCurrent: "Sem configurações antigas ou conflitos detectados",
      ...
      diagnosticFailed: "Não foi possível consultar o diagnóstico.",
      diagnosticCopied: "Relatório copiado.",
      diagnosticCopyFailed: "Não foi possível copiar o relatório.",
    ...
    display: {
      ...
      terminalIconsHint: "Ícone do terminal no grupo de meta. Sem ícone instalado, fica o nome.",
    ...
    general: {
      ...
      cleanupAfterHint:
        "A sessão só sai da lista e volta se o agente responder de novo. Com 0, nunca sai.",
